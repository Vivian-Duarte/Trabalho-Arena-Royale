        ...
        function iniciarJogo(nivelSelecionado) {
            ...
            if (modoJogo === 'boss') {
                ...
                bots.push({
                    ...
                    shootCooldown: 1500 - (nivelChefeProgresso * 50),
                    lastShot: 0,
                    angle: 0,
                    attackState: 0,
                    lastAttackChange: Date.now(),
                    strafeDir: 1,
                    stuckCounter: 0,
                    // estrutura de aprendizado
                    acoes: { 0: 0, 1: 0, 2: 0, 3: 0 },
                    lastAction: 0
                });
                ...
                if (bot.isBoss) {
                    if (alvoM) {
                        ...
                        if (now - bot.lastAttackChange > 3000) {
                            ...
                            let rand = Math.random() * (totalScore + 10); // +10 garante a exploração inicial
                            ...
                            // Fallback de segurança: se nada for escolhido, força o estado 0
